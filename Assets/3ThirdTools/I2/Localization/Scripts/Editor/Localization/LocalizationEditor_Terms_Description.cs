...
//					GUI.contentColor = GUITools.LightYellow;
		...
		public static void Translate ( string Key, ref TermData termdata, string TargetLanguageCode, GoogleTranslation.fnOnTranslated onTranslated, string overrideSpecialization )
		{
			#if UNITY_WEBPLAYER
