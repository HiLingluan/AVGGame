...
{
    [CreateAssetMenu(fileName = "SpriteCollection", menuName = "GameExtension/SpriteCollection", order = 0)]
    ...
    public class SpriteCollection : ScriptableObject
    {
        ...
        {
            m_Sprites.TryGetValue(name, out Sprite sprite);
            if(sprite == null)
            {
                Log.Warning(this.name+"²»´æÔÚSprite========"+ name);
            }
            return sprite;
        }
            ...
            else if (obj is Texture2D)
            {
                ...
                else
                {
                    ...
                    for (int j = 0; j < sprites.Length; j++)
                    {
                        ...
                        m_Sprites[sprites[j].name] = sprites[j];
                    }
                }
            }
