...
{
    public static string luaDir = Application.dataPath + "/Nova/Nova/Lua"; // Lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Nova/Nova/Sources/ThirdParty/ToLua/ToLua/Lua"; // ToLua# Lua文件目录
