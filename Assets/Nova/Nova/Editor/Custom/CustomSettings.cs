...
{
    public static string saveDir = Application.dataPath + "/Nova/Nova/Sources/ThirdParty/ToLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/Nova/Nova/Sources/ThirdParty/ToLua/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/Nova/Nova/Lua/";
