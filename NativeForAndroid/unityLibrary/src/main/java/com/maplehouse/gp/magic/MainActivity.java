...
public class MainActivity extends Activity implements IUnityPlayerLifecycleEvents
{
    ...
    @Override protected void onCreate(Bundle savedInstanceState)
    {
        ...
        CMSHelper.initActivity(this);

        CMSHelper.addEventListener(new CMSEventListener(CMSEventConst.CMS_EVENT_ALL_EVENT){
            public void onEventBack(String eventName, Object eventObject){
                UnityPlayer.UnitySendMessage("SDK",eventName,eventObject.toString());

//                Log.i("jin","onEventBack: " + eventName + " | " + eventObject.toString());
            };
        });
    }
    ...
    @Override public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        CMSHelper.onRequestPermissionsResult(requestCode, permissions, grantResults);
    }

    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        //回调
        CMSHelper.onActivityResult(requestCode, resultCode, data);
    }
