...
public class PermissionUtil {
    ...
    public static final int REQUEST_READ_PHONE = 5;
    ...
    public static boolean reqReadPhoneStatePermission()
    {
        if (Build.VERSION.SDK_INT >= 23) {
            PermissionRequest.requestPermission(Manifest.permission.READ_PHONE_STATE,PermissionUtil.REQUEST_READ_PHONE);
        }
        return false;
    }
}
